...
if(!@$_SESSION['blonde']) die('Access Denied!');
...
$config = array(
	...
	*/
	...
	'image_watermark'                          => "../../../img/watermark.png",
	...
	*******************/
	...
	'fixed_path_from_filemanager'             => array( '../../../upload/' ), //fixed path of the image folder from the current position on upload folder
	'fixed_image_creation_name_to_prepend'    => array( '' ), //name to prepend on filename
	'fixed_image_creation_to_append'          => array( '_img' ), //name to appendon filename
	...
	#                          4 / crop= resize and crop;
	*/
	'fixed_image_creation_option'             => array( 'crop' ), //set the type of the crop
	...
	'relative_image_creation_name_to_append'  => array( '_prew'), //name to append on filename
	'relative_image_creation_width'           => array( 274 ), //width of image (you can leave empty if you set height)
	'relative_image_creation_height'          => array( 154 ), //height of image (you can leave empty if you set width)
	/*
	#             $option:     0 / exact = defined size;
	#                          1 / portrait = keep aspect set height;
	#                          2 / landscape = keep aspect set width;
	...
	#                          4 / crop= resize and crop;
	*/
	'relative_image_creation_option'          => array( '3' ), //set the type of the crop
